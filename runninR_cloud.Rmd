...
* Getting Started with RStudio Connect for GCP - https://support.rstudio.com/hc/en-us/articles/360033988434-Getting-Started-with-RStudio-Connect-for-GCP
    + pre-configured from Marketplace - ready-to-use most of the time are more expensive
...
install R... and Run your code...  
is it possible to run different jobs in different terminals... interactively but not in your machine... how to keep running without being logged in
...
latest R base ???not working on google cloud??? still getting the 
```
## pre-requisite
