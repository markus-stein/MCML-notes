...
* Try It, Online or Locally - https://rcloud.social/tryit/index.html
    + support to different languages in the same code
    + everything code abd abakysis is public
...
### Container it! Rstudio with all you need in a docker container and deploy in a virtual lmachine... you dont need to instal everytinhg again and again manually... and have your code "forever"
...
Rstudio on google cloud... you can use it all iteratively, but has to install everytime you setup a virtual machine...

https://support.rstudio.com/hc/en-us/articles/115010260627-Getting-Started-with-RStudio-Workbench-RStudio-Server-Pro-Standard-for-GCP
